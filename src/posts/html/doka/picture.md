...
В этом примере пользователи с обычными экранами увидят картинку с надписью `768x400`. Пользователи, у которых retina-дисплеи, увидят картинку с надписью `1536x800`
